  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-16 md:py-24 max-w-4xl">
      <div className="text-center mb-12">
        ...
        <h1 className="font-serif text-5xl md:text-6xl text-foreground">Let's Talk</h1>
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div className="space-y-4">
          <a href={`https://wa.me/${BRAND.whatsappNumber}`} target="_blank" rel="noreferrer" className="flex items-center gap-4 bg-card p-5 rounded-md transition-all">
            <div className="w-12 h-12 rounded-full bg-gold flex items-center justify-center text-accent-foreground"><MessageCircle className="w-5 h-5" /></div>
            <div>
          ...
          <a href={BRAND.instagram} target="_blank" rel="noreferrer" className="flex items-center gap-4 bg-card p-5 rounded-md transition-all">
            <div className="w-12 h-12 rounded-full bg-gold flex items-center justify-center text-accent-foreground"><Instagram className="w-5 h-5" /></div>
            <div>
          ...
          <a href={`mailto:${BRAND.email}`} className="flex items-center gap-4 bg-card p-5 rounded-md transition-all">
            <div className="w-12 h-12 rounded-full bg-gold flex items-center justify-center text-accent-foreground"><Mail className="w-5 h-5" /></div>
            <div>
        ...
        <form onSubmit={submit} className="bg-card rounded-md p-6 md:p-8 space-y-4">
          ...
          <button disabled={sending} className="w-full bg-primary text-primary-foreground py-3.5 rounded-full text-sm tracking-[0.2em] uppercase hover:bg-gold-soft disabled:opacity-50">
            Send via WhatsApp
          </button>
        </form>
      </div>
